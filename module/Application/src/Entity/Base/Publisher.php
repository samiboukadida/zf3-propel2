 ...
 *
 *
* @package    propel.generator.Application.src.Entity.Base
*/
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Application\\Entity\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Application\Entity\Base\Publisher object.
     */
     ...
     * @return $this|\Application\Entity\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Application\\Entity\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Application\Entity\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Application\Entity\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Application\Entity\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Application\Entity\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\Application\Entity\Book');
    }
