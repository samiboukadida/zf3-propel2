...
use \Exception;
use \PDO;
use Application\Entity\Publisher as ChildPublisher;
use Application\Entity\PublisherQuery as ChildPublisherQuery;
use Application\Entity\Map\PublisherTableMap;
 ...
 *
 * @method     \Application\Entity\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Application\Entity\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Application\\Entity\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Application\Entity\Book object
     *
     * @param \Application\Entity\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($book instanceof \Application\Entity\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Application\Entity\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Application\Entity\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Application\Entity\BookQuery');
    }
