...
use \Exception;
use \PDO;
use Application\Entity\Author as ChildAuthor;
use Application\Entity\AuthorQuery as ChildAuthorQuery;
use Application\Entity\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Application\Entity\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Application\\Entity\\Author', $modelAlias = null)
    {
