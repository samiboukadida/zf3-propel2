...
use Application\Entity\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Application.src.Entity.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Application\\Entity\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Application.src.Entity.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Application\\Entity\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Application\Entity\Author) { // it's a model object
