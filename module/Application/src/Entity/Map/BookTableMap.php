...
namespace Application\Entity\Map;

use Application\Entity\Book;
use Application\Entity\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Application.src.Entity.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Application\\Entity\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Application.src.Entity.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Application\\Entity\\Book');
        $this->setPackage('Application.src.Entity');
    ...
    {
        $this->addRelation('Publisher', '\\Application\\Entity\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Application\\Entity\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Application\Entity\Book) { // it's a model object
