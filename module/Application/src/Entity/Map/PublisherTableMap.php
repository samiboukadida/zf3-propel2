...
use Application\Entity\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Application.src.Entity.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Application\\Entity\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Application.src.Entity.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Application\\Entity\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Application\\Entity\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Application\Entity\Publisher) { // it's a model object
